...
function howManyMovies(arrayMovies) {
  return arrayMovies.filter(element => element.director === "Steven Spielberg" && element.genre.includes("Drama")).length;
}
...
function scoresAverage(arrayMovies) {
  ...
  return Number((totalScores/arrayMovies.length).toFixed(2))
}
...
function orderByYear(arrayMovies) {
  ...
  console.log("first sort", typeof newArray)
  // console.log(typeof newArray.reverse())
  // return newArray
}
