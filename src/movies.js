...
function getAllDirectors(moviesArray) {
    const directorMovies = moviesArray.map(function(movie){
...
function scoresAverage(moviesArray) {
    ...
    let  averageAllScores = sum / moviesArray.length
...
function dramaMoviesScore(moviesArray) {
    ...
    let sum = drama.reduce(function(acc,movie){
        return acc + movie.score
    },0)
