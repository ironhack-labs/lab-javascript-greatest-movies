...
const sumScore = movies.reduce((accumulator, currentValue) => {
...
const avgScore = sumScore/ movies.length;
  const finalScoreAvg = parseFloat(avgScore.toFixed(2));//when you do fixed 2 
...
//   const totalScore = accumulator + currentValue.score;
