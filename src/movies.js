...
function giveDramaMovies(movie){
    const dramaMovies = movies.map((movie) => {
        return movie.genre[drama]
    })
}
// crear giveDramaMovies para darle esa "acción" a .map junto con el array de las pelis de Spilgberg
