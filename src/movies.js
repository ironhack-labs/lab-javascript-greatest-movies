...
function cleanDirectors(arrayOfDirectors) {
  const cleanList = arrayOfDirectors.filter(function (element, index, array) {
...
console.log("clean list: " + cleanDirectors(getAllDirectors(movies)));
