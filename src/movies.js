...
function howManyMovies(moviesArray){
    let Steven=0;
    const Peliculas=moviesArray.filter((movie) =>
        movie.director === 'Steven Spielberg' && movie.genre.includes('Drama'))
    Steven = Peliculas.length
    return Steven
...
function scoresAverage(moviesArray){
    ...
    Promedio=0;
    const average= moviesArray.reduce(function(sum,movies){
    ...
    Promedio=average/moviesArray.length
