...
function scoresAverage(moviesArray) {
    ...
    let avgScore = moviesArray.reduce((sum, movie) => sum + movie.score, 0);

    return  avgScore / moviesArray.length;
...
function dramaMoviesScore(moviesArray) {
    ...
    let avgScore = moviesDrama.reduce((sum, movie) => sum + movie.score, 0);
