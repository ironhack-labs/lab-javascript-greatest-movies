...
let allDirectors = moviesArray.map( unit => unit.director)
...
const pickedMovie = moviesArray.filter(unit => unit.director === "Steven Spielberg" && unit.genre.includes("Drama"));

return pickedMovie.length
