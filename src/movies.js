...
const orderByYear = movies => {
  const ordenador = [...movies]
  return ordenador.sort((a, b) => {
...
const howManyMovies = movies => {
  return movies
    ...
    .filter(drama => drama.genre.includes('Drama')).length
}
...
const orderAlphabetically = array => {
  let ordenador = [...array]
  ordenador = ordenador.sort((a, b) => a.title.localeCompare(b.title))
  ordenador = ordenador.map(array => array.title)
  return ordenador.slice(0, 20)
}
