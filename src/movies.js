...
const dramaMovie = moviesArray.filter(drama => drama.genre.includes('Drama'));
const spielbergMovie = dramaMovie.filter (movie => movie.director === 'Steven Spielberg');
...
function dramaMoviesScore(moviesArray) {
    const movies = moviesArray.filter ((movie)=> {return movie.genre.includes ('Drama')
