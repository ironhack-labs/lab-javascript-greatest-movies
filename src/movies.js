...
const reducer = (accumulator, movie) => {
  let valueOfScore = 0
  if (movie.score){
    valueOfScore = movie.score
  }
  return accumulator + valueOfScore;
 }
...
function scoresAverage(array) {
 ...
 const totals = array.reduce(reducer,0)
 return Number((totals / array.length).toFixed(2))
}
