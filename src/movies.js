...
function howManyMovies(moviesArray) {
    ...
    const spielbergMovies = moviesArray.filter  ((selector) =>
         selector.director === "Steven Spielberg" && selector.genre.includes("Drama")
    );
...
function scoresAverage(moviesArray) {
    ...
    const sumOfScores = moviesArray.reduce ((accumulator, currentValue) => {
