...
const getAllDirectors = movies.map((e) => {
    const onlyDirector = (e.director)
    return onlyDirector
})
console.log(getAllDirectors)

/*
const getAllDirecctors = (movies) => {
...
const notDuplicate = [...new Set(movies)];

console.log(notDuplicate);

// Iteration 2: Steven Spielberg. The best? - How many drama movies did STEVEN SPIELBERG direct?
/*
const howManyMovies = movies.filter(howMany => {
    return howMany.genere.drama = true
})
*/

function howManyMovies(movies) {
    const spielbergDramas = movie.filter((movies) => movies.director === "Steven Spielberg" && movies.genere.includes("Drama"));
