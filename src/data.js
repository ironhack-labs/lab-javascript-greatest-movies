...
//console.log("long previous array", movies.length);
function getAllDirectors(moviesArray) {
	...
	return console.log(dirArray.length, noDuplicatedDirectors.length);
}
...
function howManyMovies(moviesArray) {
	...
	return console.log(dramBySpilberg);
}
...
function scoresAverage(moviesArray) {
	...
	return console.log(parseFloat((result / moviesArray.length).toFixed(2)));
}
