...
describe('Function "scoresAverage"', () => {
	...
	it('should be rounded to 2 decimals places', () => {
		expect(scoresAverage([ { score: 8 }, { score: 9 }, { score: 9 } ])).toBe(8.67);
	});
...
describe('Function "orderByYear"', () => {
	...
	it('should order movies with the same year by their title, alphabetically', () => {
		expect(
			orderByYear([ { title: 'abc', year: 2002 }, { title: 'bac', year: 1982 }, { title: 'aab', year: 1982 } ])
		).toEqual([ { title: 'aab', year: 1982 }, { title: 'bac', year: 1982 }, { title: 'abc', year: 2002 } ]);
	});
});
...
describe('Function "bestYearAvg"', () => {
	...
	it('should return the correct answer to a single element array', () => {
		expect(bestYearAvg([ { year: 2007, score: 8 } ])).toEqual('The best year was 2007 with an average score of 8');
	});

	it('should return the correct answer to a multiple elements array', () => {
		expect(bestYearAvg(movies)).toEqual('The best year was 1972 with an average score of 9.2');
	});
	...
	it('should return the oldest year when there is a tie', () => {
		...
		expect(bestYearAvg(newMoviesArr)).toEqual('The best year was 1978 with an average score of 8.5');
	});
});
