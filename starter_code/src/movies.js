...
function howManyMovies(movies) {
    ...
    if (movies.length === 0) {
        ...
        if (averageSum.length === 0) {
            ...
            console.log("Steven Spielberg directed " + averageSum.length + " drama movies!");
            return ("Steven Spielberg directed " + averageSum.length + " drama movies!");
        }
    }
}
...
let onlyRight = alphabetical.slice(0, 6);
return onlyRight
}
