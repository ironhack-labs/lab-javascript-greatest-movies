...
var ratesAverage = movies.reduce(function(sum, movie){
...
var ratesAverage = dramaMovies.reduce(function(sum, movie){
  return sum + Number(movie.rate);
...
var howManyMovies = dramaMovies.filter(function(movie){
...
var orderAlphabetically = movies.sort(function(title1, title2) {
  title1 = title1.title.toLowerCase();
  title2 = title2.title.toLowerCase();
  if (title2 < title1) {
    return 1;
    } else {
      return -1;
...
movies.sort(function(year1, year2) {
