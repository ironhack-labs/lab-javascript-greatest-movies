...
function turnHoursToMinutes(arr) {
  ...
  var hora = movie.duration.split(" ")[0].substring(0, 1);
  var min = movie.duration.split(" ")[1].split("min")[0];
  var duration = Number(hora) * 60 + Number(min)
   movie.duration = duration.toString();
    console.log(movie)
})

//duracion = 60 * tie.substring(0,1) + parseFloat(tie.substring(3,5))
};
