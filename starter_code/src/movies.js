...
var movies= [
  ...
  function ratesAverage (array) {
    var gradesTotal = movies.reduce(function(acc, oneGrade) {
    return acc + parseInt(oneGrade.rate);
    },0);
    var gradesAverage = gradesTotal / movies.length;
...
function dramaMoviesRate (movies){
 var filtrer = movies.filter(function(array){
  return  array.genre.indexOf("Drama")!== -1;
})
    var gradesTotal = filtrer.reduce(function(acc, oneGrade) {
    return acc + parseInt(oneGrade.rate);
    },0);
    var gradesAverage = gradesTotal / filtrer.length;
    return Math.round(gradesAverage*100)/100;
return (ratesAverage(filtrer))
};
