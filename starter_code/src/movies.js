...
turnHoursToMinutes = (movies) => {
    ...
    const copy = movies.map(toMinutes);
    console.log("copy");
    console.log(copy);
    return copy;
}
...
dramaMoviesRate = (movies) => {
    ...
    return !dramafiltered.length ? undefined : ratesAverage(dramafiltered)
}
...
howManyMovies = (movies) => {
    ...
    return !movies.length ? undefined : "Steven Spielberg directed " + spielbergDrama.length + " drama movies!"
...
bestYearAvg = (movies) => {
    ...
    return !movies.length ? undefined : 'The best year was ' + bestYear.year + ' with an average rate of ' + maxAvg
