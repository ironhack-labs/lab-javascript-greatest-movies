...
var movies = [
  ...
  /*function turnHoursToMinutes(movies) { 
      var arrNew = arr.map(function(movie)) {
          if (movie.duration.length === 8) {
              movie.duration = parseInt(movie.duration[0])*60 + parseInt (movie.duration[3])*10 + parseInt(movie.duration[4])
          }
            ...
            movie.duration = parseInt(movie.duration[0])*60  + parseInt(movie.duration[3])
             ...
             movie.duration = parseInt(movie.duration[0])*10 + parseInt(movie.duration[1])
                }
   ...
   */ function turnHoursToMinutes(arr) {
       ...
       var arrNew = arr.map(function(movie){
           if(movie.duration.length > 2) {
            ...
            var hora = duration[0].substr(0,1);
            var minuto;
  
            if(duration[1].length==4){
                minuto=duration[1].substr(0,1);
            }else if(duration[1].length==5){
                minuto=duration[1].substr(0,2);
            } else if(duration[1].length==0) {
              minuto = 0;
            }
           }
          
  
           movie.duration = parseInt(hora)*60 + parseInt(minuto)
  ...
  function turnHoursToMinutes() {
    movies.map(function(duracion){
    return movies.duracion();
  });
  }
  */
