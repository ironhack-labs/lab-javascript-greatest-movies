...
// var total = arr.reduce(acc => rates.acc})
// console.log(number('8.0'))

// arrTotal = []
// for (i = 0 ; i < movies.length ; i++){
//   arrTotal.push(parseFloat(movies[i].rate))
// }
// function ratesAverage(arr) {
// var sum = arr.reduce(function(accumulator, currentValue, i) {
//   accumulator += currentValue;
//   return accumulator;
// }, 0);
// let moyenne = sum/arr.length
...
function dramaMoviesRate(arr) {
  ...
  const sumRateDrama = dramaMovies.reduce((accumulator, currentValue) => { return accumulator += parseFloat(currentValue.rate) }, 0);
...
// filteredNames = names.filter(function(currentName) {
